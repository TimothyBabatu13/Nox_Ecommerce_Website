...
const Input = ({ type, placeholder, clx, name, handleChange, isUp }: {
  ...
  return (
    <div className="relative">
        ...
        <input ref={reff} required onFocus={handleFocus} onBlur={handleBlur} type={type} onChange={handleChange} name={name} placeholder={!isUp ? placeholder : ''}  className={"py-[20px] px-[32px] block w-[180%] border border-[#141414] rounded-[5px] text-sixteen font-fourHundrend text-[#574240] mb-[24px]"+clx}/>
    </div>
)
}
